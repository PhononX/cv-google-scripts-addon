...
function getChannel(channelguid, timeZone) {
  ...
  try {
    ...
    // Logger.log(result)
    // Logger.log(result.json.workspace_image_url)
    // Logger.log(result.json.workspace_name)
    // Logger.log(result.json.channel_name)
    // Logger.log(result.json.last_posted_ts)
    // Logger.log(result.json.total_messages)
    // Logger.log(result.json.total_duration_milliseconds)
    // Logger.log(result.json.created_ts)
