function confirmAsyncMeetingCard(channelUrl, channelName, emails, draftNotification, hostApp, calendarId, eventId) {
...
function composeEmailCallback(e) {
  ...
  if (lastMDraft === true) {
    const card = confirmAsyncMeetingCard(channelUrl, channelName, emails, true, hostApp);
